...
git remote add origin git@github.com:ariffjeff/houdini-package-manager.git
...
[this page](https://github.com/ariffjeff/houdini-package-manager/settings/secrets/actions/new).
- Create a [new release](https://github.com/ariffjeff/houdini-package-manager/releases/new) on Github. 
